classdef BoxWorld < handle
    ...
    methods
        ...
        function of = ObstacleFree(obj, p)
        ...
        function c = ObstacleFree2(obj, p)
            % Alternative implementation of function ObstacleFree
            c = p(1, :) > obj.boxes(:, 1) & ...
                p(1, :) <= obj.boxes(:, 1) + obj.boxes(:, 3) & ...
                p(2, :) > obj.boxes(:, 2) & ...
                p(2, :) <= obj.boxes(:, 2) + obj.boxes(:, 4);
            c = ~(any(any(c)));
        end
        
        function c = ObstacleFree3(obj, p)
            % Alternative implementation of function ObstacleFree
            c = p(1, :) > obj.x_obst(:, 1) & ...
                p(1, :) <= obj.x_obst(:, 2) & ...
                p(2, :) > obj.y_obst(:, 1) & ...
...
function collision = obstacle_check(x, y, x_obst, y_obst)
    % Help function to function ObstacleCheck, to check collision for a 
    % single point x,y
    collision = 0;
